        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VendorOrAdminID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_products_AspNetUsers_VendorOrAdminID",
                        column: x => x.VendorOrAdminID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewRate = table.Column<int>(type: "int", maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalpriceForItem = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsInOrdercs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemsInOrdercs_items_itemID",
                        column: x => x.itemID,
                        principalTable: "items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemsInOrdercs_orders_orderID",
                        column: x => x.orderID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsInOrdercs_itemID",
                table: "ItemsInOrdercs",
                column: "itemID");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsInOrdercs_orderID",
                table: "ItemsInOrdercs",
                column: "orderID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_products_VendorOrAdminID",
                table: "products",
                column: "VendorOrAdminID");
